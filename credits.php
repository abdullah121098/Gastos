...
<?php } ?>
    ...
    <button class="view view2" data-toggle="modal" data-target=".bd-example-modal-lg"><i class="feather mr-2 icon-check-circle"></i>View</button></center>
        </div>
...
$result = mysqli_query($con,"SELECT * FROM `credit_gastos`");
...
<tr>
    <td><?php echo $view['sn_id']; ?></td>    
<td><input type="text" name="na" value="<?php echo $view['sn_name']; ?>"></td>
<td><input type="text" name="da" value="<?php echo $view['sn_date']; ?>"></td>    
<td><input type="text" name="ex" value="<?php echo $view['sn_credit']; ?>" size="6"></td>

<td>
<div class="btn-group">
<a href="update.php?id=<?php echo $view['sn_id']; ?>">    
    <button type="button" name="edit" class="btn btn-warning" size="4">+</button></a>
<a href="credits_erase.php?id=<?php echo $view['sn_id']; ?>">
...
if(isset($_POST['add'])){
  ...
  $date=date('Y-m-d',strtotime($_POST['dateofbirth']));
    $detail=$_POST['texted'];    
$sql1="INSERT INTO `credit_gastos`(`sn_name`, `sn_date`, `sn_credit`) VALUES ('$detail','$date','$money')";
$result1 = mysqli_query($con,$sql1);
if($result1){ ?>
 <script src="https://unpkg.com/sweetalert/dist/sweetalert.min.js"></script>
<script>swal("Credits Added ! ");
setTimeout(function(){window.location.href='credits.php';},2000);
</script>
<?php
     
}else{
    ?>
<script>swal("Error Add !");
setTimeout(function(){window.location.href='credits.php';},2000);
</script>
<?php
} }
